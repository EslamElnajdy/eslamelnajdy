...
> A vulnerability researcher focusing on Web App Security, penetration testing, and lightweight exploit engineering.
>
> Passionate about small details that reveal big issues: Account Takeover, Auth/Z Flaws, Business Logic, IDOR, Session Issues, Misconfigurations, logic bugs
...
-  **Tools:** Burp Suite, ffuf, httpx, nuclei, kiterunner, Python/Requests  
-  **Values:** No Noise, High-Signal PoCs, Clean Repro Steps, Safe & Legal
...
- Clean PoCs + actionable remediation recommendations.  
- Active on Bug Bounty platforms and responsible disclosure programs.
